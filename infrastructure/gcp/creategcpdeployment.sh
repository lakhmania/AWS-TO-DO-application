...
gcloud deployment-manager deployments create my-igm \
    ...
    --properties zone:us-east1-b,machineType:n1-standard-1,containerImage:ubuntu-1604-lts,storage:csye6225-storage,port:80,service:http,region:us-east1,sslCertificateName:csye6225-certificate,httpsport:443,tag:network-tag,instancename:$1,dnsName:$2
